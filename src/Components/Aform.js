...
const Aform = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-gray-50 shadow-md rounded-lg mt-12">
      <h2 className="text-4xl font-bold mb-6 text-center text-black"> Admission Form</h2>
