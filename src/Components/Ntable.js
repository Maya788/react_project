...
const Ntable = () => {
  return (
    <div>
        <div className="text-2xl font-bold mt-5 p-3 mb-4 bg-blue-gray-100 text-center">Notice Board
      </div>
      <table className="min-w-full container mx-auto p-6 bg-white border border-gray-300 shadow-md rounded-lg overflow-hidden">
